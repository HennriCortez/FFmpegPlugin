...
cd ffmpeg-kit
./android.sh --api-level=24 --enable-gpl --enable-shine --enable-x264 --enable-x265 --enable-libtheora --enable-opus --enable-libvorbis --enable-twolame --enable-openssl --enable-mediacodec
function copy_libs {
